      ...
      <QueueProvider>
        <div className="flex h-dvh flex-col overflow-hidden bg-slate-950 text-slate-100">
          ...
          <div className="flex flex-1 divide-x divide-white/10 overflow-hidden">
            {!isFullScreen && (
              <>
                <aside className="flex w-[420px] min-h-0 flex-col bg-slate-950/60 border-r border-white/5">
                  <div className="flex-1 min-h-0 overflow-y-auto p-2">
                    <ControlsPane />
                  </div>
                </aside>
                <section className="flex min-h-0 min-w-[420px] flex-[1.1] flex-col bg-slate-950/55 border-r border-white/5">
                  <div className="flex-1 min-h-0 overflow-y-auto p-2">
                    <FileBrowser />
                  </div>
                </section>
