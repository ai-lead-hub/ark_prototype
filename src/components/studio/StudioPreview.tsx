...
export function StudioPreview({
    ...
    return (
        <div className="flex h-full flex-col bg-black">
            ...
            {/* Bottom Input */}
            <div className="p-3 bg-[#0a0a0a] border-t border-white/5 space-y-2">
                <textarea
                    value={prompt}
                    onChange={(e) => setPrompt(e.target.value)}
                    placeholder="Describe your subject and scene..."
                    rows={2}
                    className="w-full rounded-lg border border-white/10 bg-black/50 px-3 py-2 text-sm text-white placeholder:text-slate-600 outline-none focus:border-sky-500 resize-none"
                />
