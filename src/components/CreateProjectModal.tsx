...
export default function CreateProjectModal({ isOpen, onClose, onSubmit }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="w-full max-w-2xl rounded-2xl bg-[#1a1a1a] p-8 text-slate-100 shadow-2xl">
        <h1 className="text-3xl font-bold text-white mb-6">Create Production</h1>
